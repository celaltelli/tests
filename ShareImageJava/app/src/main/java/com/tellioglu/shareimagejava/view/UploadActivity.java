...
import com.tellioglu.shareimagejava.databinding.ActivityUploadBinding;
...
public class UploadActivity extends AppCompatActivity {
    ...
    public void uploadImage(View view) {
        ...
        if (imageData != null) {
            ...
            String imageName = "images/shareImagesApp/" + uuid + ".jpg";
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result) {
                    ...
                    Toast.makeText(UploadActivity.this.getApplicationContext(), "Permession needed for gallery", Toast.LENGTH_LONG).show();
                }
